...
**Важно:** В режиме `real` конструирование JSON (`payload`) для создания объявления всё ещё базируется на базовых полях MVP (полу-мок). Перед боевым запуском в Production необходимо расширить `create_listing`, добавив точные маппинги категорий и geo-позиций из официальных справочников Авито.
